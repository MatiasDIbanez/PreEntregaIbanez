...
// let total=0;
// let suma = document.getElementsByClassName('sumaClick')
// suma.onclick = function sumaClick(){
//     total=total+1
...
botonesParaAgregar.onclick=function agregamosAlCarrito(){
    botonesParaAgregar.id=carrito[]
    console.log(carrito)
}
